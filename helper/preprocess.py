...
Data pre processing
=================================
This script represent a template for preprocessing data in production
"""
...
class PrepareFeatures:
    ...
    def __init__(self, raw_data, target, test_size=0.2, cv=5):
        ...
        self.raw_data = raw_data    # pandas dataframe of 
        self.target = target    # str: target variable name
        self.test_size = test_size  # proportion of test size
    ...
    def get_variable_types(self):
        # extract variable types form training set
        # get all categoricat variables
    ...
    def split_data(self, *, training=False):
        ...
        print("Number of samples in training set {}, test set {}".format(
